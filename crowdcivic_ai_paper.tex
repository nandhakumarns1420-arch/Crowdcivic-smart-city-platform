...
\begin{itemize}
    ...
    \item \textbf{Data Flow Diagram (Level 0 \& 1):} Level 0 maps the primary boundaries between Citizens, Admins, and the system gateway. Level 1 details internal processes, including verification checks, duplicate query routing, priority score generation, and database updates.
\end{itemize}
